...
<html lang="en">
	<head>
		<!-- Meta -->
		<meta chaLearn Freeet="utf-8">
		<meta http-equiv="Content-Type" content="text/html; chaLearn Freeet=UTF-8">
...
<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
	    ...
	    <div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/s-33.jpg);">
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading green">Adon's here.</h4>
						</div>
					</div>	
					<h6 class="text">Promote your business here.</h6>
				</div>
			</div><!-- .col -->
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading orange">freely Learn</h4>
						</div>
					</div>
					<h6 class="text">free learn on here upto end.</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Featured Courses</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					...
					<li><a href="#medical" data-toggle="tab">Medical Learning</a></li>

					<li><a href="#applied" data-toggle="tab">Applied Science</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					Learn Free.<?php //echo htmlentities($row['productPrice']);?>			</span>
										     <!--<span class="price-before-discount">Learn Free.<?php //echo htmlentities($row['productPriceBeforeDiscount']);?>	</span>-->
				...
				<div class="row">
					<div class="col-md-6">
	                   <section class="section">
	                   	<h3 class="section-title">Java Notes</h3>
...
<?php }?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">Medical Materials</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
$ret=mysqli_query($con,"select * from products where category=3");
while ($row=mysqli_fetch_array($ret)) 
