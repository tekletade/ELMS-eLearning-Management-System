...
?>
      ...
      <tr>
        <td><a href="singlevideoview.php?video_id=<?php echo $row['video_id'];?>&course_name=<?php echo $row['course_name'];?>"><img src=uploadimg/<?php echo $row['video_image']; ?>  height="100" width="150"></a></td>
