...
<html lang="en">
	<head>
	    ...
	    <title>E-Learning | Signi-in | Signup</title>
...
<div class="col-md-6 col-sm-6 create-new-account">
	...
	<p class="text title-tag-line">Create your own free account.</p>
...
<div class="form-group">
	...
	<div class="checkbox">
	  	<label class="checkbox">
		  	Speed your way through the best.
		</label>
		<label class="checkbox">
		Track your courses easily.
		</label>
		<label class="checkbox">
 Keep a record of all your courses.
		</label>
	</div>
</div>	
